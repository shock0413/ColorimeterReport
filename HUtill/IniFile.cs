...
namespace HUtill
{
    public class IniFile
    {
        ...
        public bool GetBoolian(string sectionName,
                        string keyName,
                        bool defaultValue)
        {
            string readValue = GetString(sectionName, keyName, defaultValue.ToString());
            bool retval = false;
            if(readValue.ToUpper() == true.ToString().ToUpper())
            {
                retval = true;
            }
            else
        ...
        public void WriteValue(string sectionName, string keyName, bool value)
        {
            ...
            WriteValueInternal(sectionName, keyName, value.ToString().ToUpper());
        }
